...
import com.xcw.picturebackend.manager.auth.annotation.SaSpaceCheckPermission;
...
//            }
     ...
     * 获取图片标签和分类列表
     *
     * @return BaseResponse<PictureTagCategory>
     */
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
                                                                      HttpServletRequest request) {
        Page<PictureVO> page = pictureService.listPictureVOByPageWithCache(pictureQueryRequest, request);
